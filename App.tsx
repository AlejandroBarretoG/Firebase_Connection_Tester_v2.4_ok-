...
import { ShieldCheck, Server, Database, Settings, XCircle, Code2, ChevronDown, ChevronUp, Bot, Sparkles, KeyRound, Cpu, UserCircle, HelpCircle, Key, HardDrive, TestTube2, CreditCard, Map, Activity, X, Hammer, Smartphone, Layers } from 'lucide-react';
...
type AppMode = 'firebase' | 'gemini' | 'local' | 'auth_lab' | 'roadmap' | 'voice_lab';
        ...
        <div className="fixed inset-0 z-[90] bg-slate-50/95 backdrop-blur-sm overflow-auto animate-in slide-in-from-bottom-10 fade-in duration-300">
          ...
          <div className="min-h-screen p-6 md:p-12">
            <div className="max-w-4xl mx-auto">
              ...
              {(mode !== 'local' && mode !== 'auth_lab' && mode !== 'roadmap' && mode !== 'voice_lab') && (
